# Danchev Python Style Guide

# Introduction
This style guide outlines the coding conventions for Python code developed by Danchev.
...
## Logging
* **Use a standard logging framework:**  Danchev uses the built-in `logging` module.
...
from danchev.db import user_database
